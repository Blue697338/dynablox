...
public class CsrfMiddleware : ControllerServicesExtended
{
    ...
    public static List<string> bypassUrls = new()
    {
        ...
        "/chat",
        "/chat/negotiate",
        // avatar thumbnail upload from game-server
        "/api/upload-thumbnail-v1",
        "/apisite/avatar/v1/upload-thumbnail-v1",
    };
    ...
    public async Task InvokeAsync(HttpContext ctx)
    {
        ...
        Console.WriteLine("[CSRF] Path: {0}, Method: {1}, IsBypass: {2}", pathLower, ctx.Request.Method, bypassUrls.Contains(pathLower));
        try
        {
